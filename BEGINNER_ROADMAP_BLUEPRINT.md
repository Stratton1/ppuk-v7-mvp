...
- **Authoritative docs to keep handy:**  
  `docs/PPUK_V7_COMPLETE_BLUEPRINT_V2.md`, `docs/AUTH_ROLE_ARCHITECTURE_SPECIFICATION.md`, `docs/SCHEMA_ARCHITECTURE_SPECIFICATION.md`, `docs/RLS_POLICY_PLAN.md`, `docs/roadmap.md`, `docs/current_state_and_next_steps.txt`.
