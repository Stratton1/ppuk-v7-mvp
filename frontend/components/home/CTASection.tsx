...
export function CTASection() {
  return (
    <Section className="pb-14" dataTestId="public-cta">
      <Container className="rounded-2xl border border-border/70 bg-card/80 p-6 shadow-sm backdrop-blur" dataTestId="public-cta-container">
