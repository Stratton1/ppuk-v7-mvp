...
('11111111-1111-1111-1111-111111111111', 'alice.owner@ppuk.test', 'Alice Johnson', null, 'PPUK Test', 'owner', now(), now()),
('22222222-2222-2222-2222-222222222222', 'robert.agent@ppuk.test', 'Robert Agent', null, 'PPUK Test', 'viewer', now(), now()),
...
-- Stakeholders
insert into public.property_stakeholders (user_id, property_id, role, granted_by_user_id, granted_at, expires_at, created_at, updated_at) values
('11111111-1111-1111-1111-111111111111', 'aaaaaaa1-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'owner', '11111111-1111-1111-1111-111111111111', now(), null, now(), now()),
('22222222-2222-2222-2222-222222222222', 'aaaaaaa1-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'editor', '11111111-1111-1111-1111-111111111111', now(), null, now(), now()),
('11111111-1111-1111-1111-111111111111', 'aaaaaaa2-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'owner', '11111111-1111-1111-1111-111111111111', now(), null, now(), now());
